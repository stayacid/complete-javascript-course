...
switch (true) {
  case mark.bmi > john.bmi:
    console.log(`${mark.fullName} has bigger BMI: ${mark.bmi}`);
    break;
  case john.bmi > mark.bmi:
    console.log(`${john.fullName} has bigger BMI: ${john.bmi}`);
    break;
  default:
    console.log(`Guys have equal BMI: ${mark.bmi}`);
    break;
}